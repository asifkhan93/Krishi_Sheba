...
?>
  <main id="main">
	...
	<table class="table table-striped table-bordered" style="width:100%" class="datatable">
	  <tbody>
		<tr>
		  <th width="175" height="34" align="right"><strong>আপনার নাম:</strong></th>
		  <td ><?php echo $rsdisp[customer_name]; ?></td>
		</tr>
		<tr>
		  <th height="48" align="right"><strong>আপনার ঠিকানা:</strong></th>
		...
		<tr>
		  <th height="39" align="left"><strong>যোগাযোগের নাম্বার:</strong></th>
		  <td><?php echo $rsdisp[contact_no]; ?></td>
		</tr>
		<tr>
		  <th height="35" align="left"><strong>মোবাইল নাম্বার:</strong></th>
		  <td><?php echo $rsdisp[mobile_no]; ?></td>
		</tr>
		<tr>
		  <th height="39" align="left"><strong>ইমেইল আইডি:</strong></th>
		  <td><?php echo $rsdisp[email_id]; ?></td>
		</tr>
		<tr>
		  <th height="33" align="left"><strong>ক্রেতার ধরন:</strong></th>
