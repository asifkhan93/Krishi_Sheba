...
{
?>
<li data-filter="*" class="filter-active">সকল যন্ত্রপাতি</li>
<?php
}
?>
<?php			  
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
				...
				/*
				  ...
				  */
				?>
                  <a href="displayproductsdetailed.php?productid=<?php echo $rs[0]; ?>" title="More Details" class="btn btn-info"><i class="bx bx-link"></i> বিস্তারিত দেখুন</a>
                </div>
              </div>
            </div>
          </div>
