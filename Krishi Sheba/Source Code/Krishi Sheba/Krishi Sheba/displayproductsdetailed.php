    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>কৃষকদের যন্ত্রপাতির বিবরণ</h2>
          <ol>
...
?>	
          ...
          <div class="portfolio-info">
            <h3>পণ্যের বিবরণ</h3>
            <ul>
              <li><strong>পণ্যের নাম</strong>: <?php echo $rs[product_name]; ?></li>
              <li><strong>ক্যাটাগরি</strong>: <?php echo $rscategory['category']; ?></li>
              <li><strong>দাম</strong>: <?php echo $rs['cost']; ?></li>
              <li><strong>পরিমান</strong>: <?php echo $rs['quantity_type']; ?></li>
    <?php
	if(isset($_SESSION[customerid]) || isset($_SESSION[sellerid]))
	{
	?>
              <li><a href="displaycart.php?prodid=<?php echo $rs[0]; ?>&prodcost=<?php echo $rs[cost]; ?>" class="btn btn-info">কার্টে যোগ করুন</a></li>
    <?php
	}
	else
	{
	?>   
              <li><a href="customerloginpanel.php?pagename=<?php echo basename($_SERVER['PHP_SELF']); ?>&productid=<?php echo $_GET[productid]; ?>" class="btn btn-warning" style="width: 100%;">ক্রেতা হিসেবে লগইন করুন</a></li>
              <li><a href="sellerloginpanel.php?pagename=<?php echo basename($_SERVER['PHP_SELF']); ?>&productid=<?php echo $_GET[productid]; ?>" class="btn btn-warning" style="width: 100%;">বিক্রেতা হিসেবে লগইন করুন</a></li>
	<?php
	}
	?>
            </ul>
