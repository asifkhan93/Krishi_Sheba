...
{
?>
<li data-filter="*" class="filter-active">সকল পণ্য</li>
<?php
}
?>
            </ul>
...
<span id='loadstate'><select name="state"  autofocus class="search_categories form-control" onChange="loadcity(this.value)" ><option value="">বিভাগ নির্বাচন করুন</option>
<?php
...
<span id='loadcity'><select name="city"  autofocus class="search_categories form-control"><option value="">জেলা নির্বাচন করুন</option><?php
...
?></select></span>
      ...
      <a href="displaysales.php">মুছে ফেলুন</a>
                </div>
              </div>
            </div>
</form>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p><strong>পরিমাপ :</strong> <?php echo $rs['quantity']; ?> <?php echo $rs['quantity_type']; ?></p>
                <div class="portfolio-links">
                  <a href="displaysalesdetailed.php?productid=<?php echo $rs[0]; ?>" title="More Details" class="btn btn-info"><i class="bx bx-link"></i> বিস্তারিত দেখুন</a>
                </div>
              </div>
            </div>
          </div>
