    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>কৃষকের মার্কেট বিস্তারিত</h2>
          <ol>
...
?>	
          ...
          <div class="portfolio-info">
            <h3>পণ্যের বিস্তারিত তথ্য</h3>
            <ul>
              <li><strong>পণ্যের নাম</strong>: <?php echo $rs[title]; ?></li>
              <li><strong>বিক্রেতার নাম:</strong>: <?php echo $rsseller[seller_name]; ?></li>
              <li><strong>ক্যাটাগরি</strong>: <?php echo $rscategory['category']; ?></li>
              <li><strong>পণ্য</strong>: <?php echo $rsproduce['produce']; ?></li>
              <li><strong>জাত</strong>: <?php echo $rsvariety['variety']; ?></li>
              <li><strong>পরিমান</strong>: <?php echo $rs[quantity]; ?> <?php echo $rs['quantity_type']; ?></li>
            </ul>
          </div>
...
<h4> ক্রয়ের অনুরোধ প্রেরণ করুন</h4>
...
<div class="form-row">
	...
	ক্রয়ের পরিমান<font color="#FF0000">*</font> <font color="#FF0000">  (in <?php echo $rs[quantity_type]; ?> ) </font>
	...
	<div class="col-md-6 form-group">
		ক্রয়ের দিন<font color="#FF0000">*</font> <font color="#FF0000">  (in <?php echo $rs[quantity_type]; ?> ) </font>
		<input type="date" name="requestdate" id="requestdate" readonly value="<?php echo date("Y-m-d"); ?>" class="form-control">
	</div>
	
	<div class="col-md-6 form-group">
		অনুরোধের শেষ সময়<font color="#FF0000">*</font> <font color="#FF0000">  (in <?php echo $rs[quantity_type]; ?> ) </font>
	...
	<b>প্রয়োজনীয় যে কোন তথ্য:</b>
<textarea name="note" id="note" class="form-control" ><?php echo $rsedit[note]; ?></textarea>
	</div>
	
	<div class="col-md-12 form-group">
	<input type="submit" name="submit" id="submit" value="ক্রয়ের অনুরোধ পাঠানের জন্য ক্লিক করুন.." class="btn btn-info">
	</div>
						   ...
						   {
							?>
                             <h2><a href='customerloginpanel.php?pagename=<?php echo basename($_SERVER['PHP_SELF']); ?>&productid=<?php echo $rs[product_id]; ?>'  class="btn btn-info">ক্রয়ের অনুরোধ পাঠানের জন্য লগইন করুন</a></h2>  
                           <?php
						   }
				}
						   ?>
