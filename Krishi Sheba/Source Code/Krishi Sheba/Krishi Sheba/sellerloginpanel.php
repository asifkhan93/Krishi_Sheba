...
<a href="sellerforgotpassword.php">পাসওয়ার্ড ভুলে গিয়েছেন ?</a>
...
<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block" >লগইন করতে ক্লিক করুন</button>
              ...
              <div class="col-md-3 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
                  <h4><a href="seller.php">নতুন ব্যভয়ারকারী</a></h4>
                  <div class="icon"><i class="bx bx-file"></i></div>
				  <button type="button" class="btn btn-warning btn-lg btn-block"  onclick="window.location='seller.php'" >রেজিস্ট্রেশন করুন (সম্পূর্ণ বিনামূল্যে)</button>
                </div>
              </div>
