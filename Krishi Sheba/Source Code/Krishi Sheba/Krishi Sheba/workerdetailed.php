    ...
    <div class="pricing-table pricing-three-column row">
		<div class="plan col-sm-12 col-lg-12">
          ...
          <ul>
            ...
            <li class="plan-feature"><a href='imgworker/<?php echo $rsedit[biodata]; ?>' target="_blank" class="btn btn-secondary" >বায়োডাটা ডাউনলোড করুন</a></li>
			
            <li class="plan-feature"><b>জন্ম তারিখ:</b> <?php echo date("d-M-Y",strtotime($rsedit['date_of_birth'])); ?></li>
			
            <li class="plan-feature"><b>প্রত্যাশিত পারিশ্রমিক:</b> <?php echo $rsedit[expected_salary]; ?>/day </li>
            ...
            <li class="plan-feature">
                        ...
                        <?php
						  ...
						  {
						?>
<a href="workerrequest.php?workerid=<?php echo $_GET[workerid]; ?>" class="btn btn-primary btn-plan-select"><i class="icon-white icon-ok"></i> অনুরোধ পাঠান </a>
                        <?php
						  }
						  else
						  {
						?>
<a href="sellerloginpanel.php?redirectlink=<?php echo "workerrequest.php"; ?>&workerid=<?php echo $_GET[workerid]; ?>" class="btn btn-primary btn-plan-select"><i class="icon-white icon-ok"></i> লগইন করুন এবং অনুরোধ পাঠান </a>                          
    	                  <?php
						  }
						  ?>
