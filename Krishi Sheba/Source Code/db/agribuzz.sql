...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2021 at 06:32 PM
...
(21, ' Chemical Fertilizer', 'SellingProduct', 'Supervit is a micronutrient for plants, each 100-gram pack contains:\r\n\r\nS (Sulfur)	3.4\r\nZn (Zinc)	0.5\r\nB (Boron)	0.25\r\nNa (Sodium)	0.18\r\nMg (Magnesium)	0.45\r\nCa (Calcium)	0.75', '1429822107490.jpg', 'Active'),
...
(28, 'item', 'SellingProduct', 'Supervit is a micronutrient for plants, each 100-gram pack contains:\r\n\r\nS (Sulfur)	3.4\r\nZn (Zinc)	0.5\r\nB (Boron)	0.25\r\nNa (Sodium)	0.18\r\nMg (Magnesium)	0.45\r\nCa (Calcium)	0.75', '2060922676490.jpg', 'Active');
...
(2, 1, 3, 'dhaka', 'Dhaka is the capital city of Bangladesh, in southern Asia. Set beside the Buriganga River, it’s at the center of national government, trade and culture. ', 'Active'),
(3, 1, 5, 'Mymensingh', 'Mymensingh is the capital of Mymensingh Division, Bangladesh. Located on the bank of Brahmaputra River, about 120 km north from Dhaka, it is a major financial center and educational hub of north central Bangladesh.', 'Active'),
(4, 1, 2, 'Chattogram', 'Chittagong District, officially known as Chattogram District,[2] is a district located in the south-eastern region of Bangladesh. It is a part of the Chittagong Division. The port city of Chittagong, second largest city in Bangladesh, is located in this district.', 'Active'),
(5, 1, 1, 'Barisal', 'Barisal District, officially spelled Barishal District from April 2018,[3] is a district in south-central Bangladesh, formerly called Bakerganj district, established in 1797.', 'Active'),
(6, 1, 2, 'Comilla', 'Comilla District, officially known as Cumilla District,[6] is a district of Bangladesh located about 100 kilometres south east of Dhaka.', 'Active'),
(7, 1, 3, 'Gazipur', 'Gazipur District a district of Dhaka Division in Bangladesh. It has an area of 1741.53 km2', 'Active'),
(8, 1, 2, 'Noakhali', 'Noakhali , historically known as Bhulua , is a district in South-eastern Bangladesh, located in the Chittagong Division.[2][3] It was established as district in 1821, and officially named Noakhali in 1868.', 'Active'),
(9, 1, 3, 'Kishoreganj', 'Kishoreganj  is a district in Dhaka Division of Bangladesh. . The district Kishoreganj consists of 8 municipalities, 13 upazilas, 105 union parishads, 39 wards, 145 mahallas, 946 mouzas and 1775 villages.', 'Active'),
(10, 1, 3, 'Narayanganj ', 'Narayanganj District  is a district in central Bangladesh which is a part of the Dhaka Division.[1] It is home to the ancient city of Sonargaon and is one of the oldest industrial districts in the country. ', 'Active'),
(11, 1, 3, 'Tangail', 'Tangail formerly Tangail Upzilla of Greater Mymensingh district is a district (zila) in the central region of Bangladesh. It is the largest district of Dhaka division by area and second largest by population (after Dhaka district). ', 'Active'),
(12, 1, 3, 'Narsingdi ', 'Narsingdi District  is a district in central Bangladesh. It is located 50 km north-east of Dhaka, capital city of Bangladesh. It is a part of the Dhaka Division. The district is famous for its textile craft industry.', 'Active'),
(13, 1, 4, 'Khulna', 'Khulna District, Khulna Jela also Khulna Zila) is a district of Bangladesh. It is located in the Khulna Division. I', 'Active'),
(14, 1, 5, 'Jamalpur', 'Jamalpur , Jamalpur Jela also Jamalpur Zila) is a district in Bangladesh,[2] part of the Mymensingh Division. It was established in 1978.', 'Active'),
(15, 1, 5, '	Netrokona', 'Netrokona is a district of the Mymensingh Division in northern Bangladesh.', 'Active'),
(16, 1, 5, 'Sherpur ', 'Sherpur , Sherpur Jela also Sherpur Zila) is a district in Northern Bangladesh. It is a part of Mymensingh Division. Sherpur district was a sub-division of Jamalpur District.', 'Active'),
(17, 1, 6, 'Pabna', 'Pabna District  is a district in central Bangladesh. It is one of the \"economically important districts\" in Bangladesh. Its administrative capital is the eponymous Pabna town.', 'Active'),
(18, 1, 6, 'Natore', 'Natore is a district of Rajshahi Division located in northern Bangladesh. It borders the metropolitan city of Rajshahi, and used to be part of Rajshahi district.', 'Active'),
(19, 1, 7, 'Rangpur', 'Rangpur is a district in Northern Bangladesh. It is a part of the Rangpur Division.', 'Active'),
(20, 1, 8, 'Sylhet', 'Sylhet district was established on 3 January 1782, and until 1878 it was part of Bengal province. In that year, Sylhet was included in the newly created Assam Province', 'Active'),
(21, 1, 8, 'Moulvibazar', 'The name of the district, Moulvibazar is named after its headquarter, Moulvibazar. The word is derived from two words, moulvi and bazar, meaning \'Market of the Moulvi\'. \'Moulvi\' is an Islamic honorific title and \'bazar\' is the Bengali word for market or township. ', 'Active'),
(22, 1, 7, 'Kurigram', 'Kurigram District  is a district of Bangladesh in the Rangpur Division. The district is locted in northern Bangladesh along the country\'s border with India.[3] Under Indian rule, the area was organized as a mahakuma and was not established as a district until 1984.', 'Active'),
(23, 1, 7, 'Dinajpur', 'Dinajpur district  is a district in the Rangpur Division of northern Bangladesh. Dinajpur is the largest district among all sixteen northern districts of Bangladesh.', 'Active'),
(24, 1, 6, 'Naogaon', 'Naogaon is a district in northern Bangladesh, part of the Rajshahi Division.[2] It is named after its headquarters, the city of Naogaon in Naogaon Sadar Upazila.', 'Active'),
(25, 1, 6, 'Natore', 'Natore is a district of Rajshahi Division[2] located in northern Bangladesh. It borders the metropolitan city of Rajshahi, and used to be part of Rajshahi district.', 'Active'),
(26, 1, 7, 'Rajshahi', 'Rajshahi District is a district in mid-western Bangladesh. It is a part of the Rajshahi Division.[3] The metropolitan city of Rajshahi is in Rajshahi District.', 'Active'),
...
(1, 'adeel', 'badda,dhaka', 5, 3, 1, '5896741', 'Rent worker', '7180875341.docx', '12345678999', '1998-05-04', 'rajkiran23@gmail.com', 'q1w2e3r4', 15000.00, 'Active'),
(2, 'adeel', 'badda,dhaka', 5, 3, 1, '5896741', 'Rent worker', '7180875341.docx', '12345678999', '1998-05-04', 'rajkiran23@gmail.com', 'q1w2e3r4', 15000.00, 'Active'),
(3, 'adeel', 'badda,dhaka', 5, 3, 1, '5896741', 'Rent worker', '7180875341.docx', '12345678999', '1998-05-04', 'rajkiran23@gmail.com', 'q1w2e3r4', 15000.00, 'Active'),
...
--
ALTER TABLE `product_purchase_record`
  MODIFY `purchase_record_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
